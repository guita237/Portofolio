        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-lg">
            ...
            <div className="flex justify-center space-x-6 sm:space-x-8">
              <a href="https://www.linkedin.com/in/guirauld-noumboussi-tayon-625687175/" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 bg-blue-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-blue-700 transition-colors">
